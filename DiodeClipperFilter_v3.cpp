/**
 * \file DiodeClipperFilter_v3.cpp
 */

#include "DiodeClipperFilter_v3.h"
...
namespace ATKADC
{
  ...
  class DiodeClipperFilterv3<DataType_>::SimpleOverdriveFunction
  {
  public:
  ...
  DiodeClipperFilterv3<DataType>::DiodeClipperFilterv3()
  ...
  template <typename DataType>
  void DiodeClipperFilterv3<DataType>::setup()
  {
    Parent::setup();
  ...
  template <typename DataType>
  void DiodeClipperFilterv3<DataType>::process_impl(std::size_t size) const
  {
...
BOOST_AUTO_TEST_CASE(DiodeClipperFilterv3_const_sin1k)
{
	...
	ATKADC::DiodeClipperFilterv3<double> filter;
