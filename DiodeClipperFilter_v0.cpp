/**
 * \file DiodeClipperFilter_v0.cpp
 */

#include "DiodeClipperFilter_v0.h"
...
namespace ATKADC
{
  ...
  class DiodeClipperFilterv0<DataType_>::SimpleOverdriveFunction
  {
  public:
  ...
  DiodeClipperFilterv0<DataType>::DiodeClipperFilterv0()
  ...
  template <typename DataType>
  void DiodeClipperFilterv0<DataType>::setup()
  {
    Parent::setup();
  ...
  template <typename DataType>
  void DiodeClipperFilterv0<DataType>::process_impl(std::size_t size) const
  {
...
BOOST_AUTO_TEST_CASE(DiodeClipperFilterv0_const_sin1k)
{
	...
	ATKADC::DiodeClipperFilterv0<double> filter;
