/**
 * \file DiodeClipperFilter_v1.cpp
 */

#include "DiodeClipperFilter_v1.h"
...
namespace ATKADC
{
  ...
  class DiodeClipperFilterv1<DataType_>::SimpleOverdriveFunction
  {
  public:
  ...
  DiodeClipperFilterv1<DataType>::DiodeClipperFilterv1()
  ...
  template <typename DataType>
  void DiodeClipperFilterv1<DataType>::setup()
  {
    Parent::setup();
  ...
  template <typename DataType>
  void DiodeClipperFilterv1<DataType>::process_impl(std::size_t size) const
  {
...
BOOST_AUTO_TEST_CASE(DiodeClipperFilterv1_const_sin1k)
{
	...
	ATKADC::DiodeClipperFilterv1<double> filter;
