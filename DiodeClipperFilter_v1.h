/**
* \file DiodeClipperFilter_v1.h
*/

#ifndef ATKADC_DIODECLIPPERFILTERV1_H
#define ATKADC_DIODECLIPPERFILTERV1_H
...
namespace ATKADC
{
	...
	class DiodeClipperFilterv1 final : public ATK::TypedBaseFilter<DataType_>
	{
