/**
 * \file DiodeClipperFilter_v2.cpp
 */

#include "DiodeClipperFilter_v2.h"
...
namespace ATKADC
{
  ...
  class DiodeClipperFilterv2<DataType_>::SimpleOverdriveFunction
  {
  public:
  ...
  DiodeClipperFilterv2<DataType>::DiodeClipperFilterv2()
  ...
  template <typename DataType>
  void DiodeClipperFilterv2<DataType>::setup()
  {
    Parent::setup();
  ...
  template <typename DataType>
  void DiodeClipperFilterv2<DataType>::process_impl(std::size_t size) const
  {
...
BOOST_AUTO_TEST_CASE(DiodeClipperFilterv2_const_sin1k)
{
	...
	ATKADC::DiodeClipperFilterv2<double> filter;
